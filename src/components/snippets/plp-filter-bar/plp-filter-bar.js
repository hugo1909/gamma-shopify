...
function PlpFilterBar({ isMobile, isLoading, pagination, activeFilters, sortOrder, sortOptions, setActiveFilters, applySort, selectedValues, hideTotalItems, hideSort }) {
  ...
  return (
    <div className="flex justify-between">
      ...
      {!isLoading && pagination && !hideTotalItems ? <PlpFilterCount total={pagination.totalProducts} /> : !hideTotalItems ? <PlpFilterSkeleton className="w-[67px] pr-6" /> : null }
      {!isLoading && sortOptions.length && !hideSort ? (
